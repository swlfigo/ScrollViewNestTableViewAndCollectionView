//
//  ScrollViewNormalViewController.m
...
//最底部的ScrollView
@interface BackGroundNestNormalScrollView:UIScrollView

@end

@implementation BackGroundNestNormalScrollView
//防止手势冲突
...
@interface ScrollViewNormalViewController ()<UIScrollViewDelegate,SegmentSwipViewDelegate,SegmentSwipViewDataSource>

//App底部Tabbar高度
@property(nonatomic,assign)CGFloat tabBarHeight;

//底部ScrollView
@property(nonatomic,strong) BackGroundNestNormalScrollView *bgScrollView;
...
//Hold Header View
@property (nonatomic,strong) ScrollViewNormalHeaderView *headerView;
...
@implementation ScrollViewNormalViewController
...
-(BackGroundNestNormalScrollView *)bgScrollView{
    if (!_bgScrollView) {
        _bgScrollView = [[BackGroundNestNormalScrollView alloc]initWithFrame:CGRectMake(0, 0, SL_SCREEN_WIDTH, SL_SCREEN_HEIGHT)];
    }
    return _bgScrollView;
}

-(ScrollViewNormalHeaderView *)headerHoldView{
    if (!_headerView) {
        _headerView = [[ScrollViewNormalHeaderView alloc]initWithFrame:CGRectMake(0, 0, SL_SCREEN_WIDTH, _headerViewTotalHeight)];
    }
    return _headerView;
}
